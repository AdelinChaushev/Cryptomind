"""
Test script to verify OCR service is working correctly.
Run this AFTER starting the service (python app.py).

Usage:
    python test_service.py                    # Test health check only
    python test_service.py path/to/image.png  # Test health + OCR extraction
"""
...
def test_ocr_with_file(image_path):
    """Test OCR extraction with an actual image file."""
