...
const badgeImg = '/badges/Badge_16.png';
            ...
            return (
                <div className="secret-state secret-state--success">
                    ...
                    <p className="secret-state-text">
                        ...
                        Значката <strong>„Luminous Secret"</strong> вече е във вашия профил.
                    </p>
        ...
        if (alreadyClaimed || status === 'already') {
            return (
                <div className="secret-state secret-state--claimed">
                    ...
                    <p className="secret-state-text">
                        {errorMessage || 'Значката „Luminous Secret" вече присъства във вашия профил. Не можете да я заявите повторно.'}
                    </p>
        ...
        return (
            <div className="secret-state">
                ...
                <p className="secret-state-text">
                    ...
                    <strong> „Luminous Secret"</strong> към своя профил.
                </p>
