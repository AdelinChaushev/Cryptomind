...
const TYPE_CONFIG = {
    ...
    [NotificationType.CipherDeleted]: {
        variant: 'rejected',
        label: 'Cipher removed',
        icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14H6L5 6"/></svg>,
    },
    [NotificationType.CipherRestored]: {
        variant: 'info',
        label: 'Cipher restored',
